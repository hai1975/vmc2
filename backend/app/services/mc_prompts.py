...
def build_program2_gemini_system_instruction() -> str:
    ...
    return (
        ...
        "- Tên ca sĩ khách mời: Trân Oanh — viết ĐÚNG 'Trân Oanh', KHÔNG 'Trần Oánh', KHÔNG 'Trần Oanh', KHÔNG 'Tran Oanh'.\n"
...
def build_program2_gemini_opening_prompt(mc_script: str) -> str:
    ...
    return (
        ...
        "Tên ca sĩ: Trân Oanh — đọc đúng 'Trân Oanh', tuyệt đối không đổi thành Trần Oánh hay Trần Oanh.\n"
