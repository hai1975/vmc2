...
def build_southern_vietnamese_voice_section() -> str:
    return "\n".join(
        [
            ...
            "• Xưng hô: follow the XƯNG HÔ section (age + gender + pediatric vs adult + bot voice gender).",
            "• Do NOT use generic 'bạn' when speaking Vietnamese — use anh/chị/cô/chú/bác/em/cháu as appropriate.",
